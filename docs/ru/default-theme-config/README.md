...
### Отображение ссылок заголовков для всех страниц

Боковая панель отображает ссылки заголовков только текущей активной страницы. Вы можете отобразить все ссылки заголовков для каждой страницы с помощью `themeConfig.displayAllHeaders: false`:
